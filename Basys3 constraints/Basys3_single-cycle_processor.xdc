...
##7 segment display
set_property PACKAGE_PIN W7 [get_ports {seg7[7]}]					
set_property PACKAGE_PIN W6 [get_ports {seg7[6]}]					
set_property PACKAGE_PIN U8 [get_ports {seg7[5]}]					
set_property PACKAGE_PIN V8 [get_ports {seg7[4]}]					
set_property PACKAGE_PIN U5 [get_ports {seg7[3]}]					
set_property PACKAGE_PIN V5 [get_ports {seg7[2]}]					
set_property PACKAGE_PIN U7 [get_ports {seg7[1]}]					
set_property PACKAGE_PIN V7 [get_ports {seg7[0]}]							
...
##Pmod Header JC
set_property PACKAGE_PIN K17 [get_ports {btn_run}]					
set_property PACKAGE_PIN M18 [get_ports {btn_stop}]					
set_property PACKAGE_PIN N17 [get_ports {btn_reset}]					
set_property PACKAGE_PIN P18 [get_ports {btn_load}]					
